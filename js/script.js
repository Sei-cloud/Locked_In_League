document.addEventListener("DOMContentLoaded", function () {
  ...
  teams.forEach((team) => {
    ...
    document.addEventListener("keydown", function (e) {
      if (addModal.style.display === "flex" && e.key === "Escape")
        hideAddModal();
    });
    ...
    document.addEventListener("keydown", function (e) {
      if (deleteModal.style.display === "flex" && e.key === "Escape")
        hideDeleteModal();
    });
  ...
  playerModal
    .querySelector(".modal-bg")
    .addEventListener("click", hidePlayerModal);
  playerModal
    .querySelector(".modal-close")
    .addEventListener("click", hidePlayerModal);
  playerModal
  ...
  document.addEventListener("keydown", function (e) {
    if (playerModal.style.display === "flex" && e.key === "Escape")
      hidePlayerModal();
  });
  ...
  teamInfoContent.addEventListener("keydown", function (e) {
    if (
      (e.key === "Enter" || e.key === " ") &&
      e.target.classList.contains("player-link")
    ) {
      e.target.click();
    }
  });
